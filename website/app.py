...
def load_image():
    """Load an image and return both the uploaded file and the image array"""
    uploaded_file = st.file_uploader(label='Choose an image file', type=['jpg', 'jpeg', 'png'])
...
def main():
    ...
    if input_type == 'Image':
        uploaded_file, image = load_image()
