...
def main():
    ...
    if selected == "Image":
        ...
        st.warning("Real-time detection is not implemented in this demo. It would require additional setup and possibly a different architecture.")
        st.info("For real-time detection, you might consider using a webcam feed or integrating with a live video stream.")
